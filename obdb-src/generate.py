...
Generated from obdb-src (CC BY-SA 4.0)

Original source: https://github.com/OBDb/
License: https://creativecommons.org/licenses/by-sa/4.0/

Modifications: converted to python OBDCommand objects
"""
...
def emit_source_block(source_name, data):
    ...
    for entry in data.get("commands", []):
        ...
        for index, signal in enumerate(signals):
            ...
            unit_repr = repr(unit) if unit is not None else "None"
            min_repr = repr(value_min) if value_min is not None else "None"
            max_repr = repr(value_max) if value_max is not None else "None"
            ...
            lines.append(
                ...
                f'_make_decoder(bytes.fromhex("{cmd_info["response_prefix_hex"]}"), {bix}, {bitlen}, {repr(mul)}, {repr(add)}, {repr(div)}, {signed}, {unit_repr}, {min_repr}, {max_repr})'
